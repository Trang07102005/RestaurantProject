      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        <div className="mt-2 flex flex-wrap gap-2">
            <button
                ...
                title="Tách hóa đơn thành nhiều hóa đơn nhỏ hơn"
            ...
            <button
              ...
              title="Ghép nhiều hóa đơn thành một"
        ...
        <div className="flex items-center justify-between p-3 border-t bg-white">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1 rounded-md bg-white border text-sm disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed hover:bg-gray-100 hover:border-gray-400 transition-all duration-200"
            >
              {'<<'}
            </button>
              ...
              {Array.from({ length: pages }).slice(Math.max(0, page - 3), Math.min(pages, page + 2)).map((_, idx) => {
                ...
                return (
                  <button
                    ...
                    title={`Trang ${pageNum}`}
                    className={`px-3 py-1 rounded-md text-sm cursor-pointer transition-all duration-200 ${pageNum === page ? 'bg-gray-900 text-white' : 'bg-white border hover:bg-gray-100 hover:border-gray-400'}`}
                  >
                    {pageNum}
                  </button>
                );
